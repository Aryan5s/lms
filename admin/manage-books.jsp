...
%>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <a href="edit-book.jsp?bookid=<%=rs.getString("bookid")%>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Edit</button> 
                                          <a href="manage-books.jsp?del=<%=rs.getString("bookid")%>" onclick="return confirm('Are you sure you want to delete?');"" >  <button class="btn btn-danger"><i class="fa fa-pencil"></i> Delete</button>
                                            </td>
                                        </tr>
 <% cnt=cnt+1;
}
